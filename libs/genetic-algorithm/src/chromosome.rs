...
mod test{
    ...
    mod iter {
        ...
        fn test() {
            ...
            let gens: Vec<_> = chromosome.iter().collect();

            assert_eq!(gens.len(),3);
            assert_eq!(gens[0],&3.0);
            assert_eq!(gens[1],&1.0);
            assert_eq!(gens[2],&2.0);
        }
    }
    ...
    mod iter_mut {
        ...
        fn test() {
            ...
            assert_eq!(gens.len(),3);
            assert_eq!(gens[0],&30.0);
            assert_eq!(gens[1],&10.0);
            assert_eq!(gens[2],&20.0);
        }
    }
